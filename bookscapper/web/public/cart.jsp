...
<%@page import="com.nimbalkar.chetan.Book"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="com.nimbalkar.chetan.Cart, com.nimbalkar.chetan.SignIn"%>
...
<html>
    ...
    <main role="main">
      ...
      <div class="album py-5 bg-light">
        ...
        <% for(Book b : myCart.getCartItems()) { %>
            <div class="col-md-4">
                ...
                <div class="card-body">                
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      ...
                      <button type="button" class="btn btn-sm btn-outline-secondary">Remove from cart</button>
                    </div>
                  </div>
                </div>
              </div>
